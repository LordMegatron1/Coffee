...
class DetailsPage extends StatefulWidget {
  ...
  DetailsPage(this.coffeename,this.coffeedescription,this.coffeeprice,this.coffeefavorited);


  @override
  _DetailsPageState createState() => _DetailsPageState(coffeename,coffeedescription,coffeeprice,coffeefavorited);
}
...
class _DetailsPageState extends State<DetailsPage> {
  ...
  _DetailsPageState(this.coffeename,this.coffeedescription,this.coffeeprice,this.coffeefavorited);
              ...
              Positioned(
                  ...
                  child: Container(
                      ...
                      child: ListView(
                        ...
                        Text(
                          'Preparation time',
                          style: GoogleFonts.comicNeue(textStyle: const TextStyle(fontSize: 14,
                        ...
                        Container(
                            height: 110.0,
                            child: ListView(
                                padding: EdgeInsets.all(0),scrollDirection: Axis.horizontal,shrinkWrap: false,
                                physics: const BouncingScrollPhysics(),
                                children: [
                                  buildIngredientItem(
                                      'Water',
                                  ...
                                  buildIngredientItem(
                                      'Brewed Espresso',
                                      Icon(Icons.accessibility_new, size: 18.0, color: Colors.white),
                                      Color(0xFF615955)),
                                  buildIngredientItem(
                                      'Sugar',
                                      Icon(Icons.accessibility_new, size: 18.0, color: Colors.white),
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  //<-------------------------------------------------------------------------->
                                  //create function on click to text --> to set data to order and go away ->
                          ...
                          children: [
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                SizedBox(width: 15.0),
                                //give to heart is this item is favorited or not
                                Heart(coffeefavorited,coffeename,coffeedescription,coffeeprice)
                              ],
                            ),
                            SizedBox(height: 10.0),
                            Container(
