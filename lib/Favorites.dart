  ...
  Widget build(BuildContext context) {
    ...
    Future<void> getDatafromFavorites() async {
      ...
      Future.delayed(const Duration(seconds: 0), () => Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>
          Favoriting(productname_favorites,productdescription_favorites,productprice_favorites)),(route)=>false)
      );
    }
...
class Favoriting extends StatefulWidget{
  ...
  Favoriting(this.productname_favorites,this.productdescription_favorites,this.productprice_favorites);

  FavoritingState createState()=> FavoritingState(productname_favorites,productdescription_favorites,productprice_favorites);
}
...
class FavoritingState extends State<Favoriting>{
  ...
  FavoritingState(this.productname_favorites,this.productdescription_favorites,this.productprice_favorites);
        ...
        children: [
          ...
          Padding(padding: EdgeInsets.only(left: width/20,right: width/20,top: 20),
              child: Container(
                ...
                child:Favorite(productname_favorites, productdescription_favorites, productprice_favorites)
              )
          ),
...
class Favorite extends StatefulWidget{
  ...
  FavoriteState createState()=>FavoriteState(productname, productdescription, productprice);
}
        ...
        itemBuilder: (BuildContext context, int idx){
          return
            _coffeeListCard("assets/images/coffee.png", productname[idx], "CoffeeShop"
                , productdescription[idx], productprice[idx], true, width, height);
        });
  }
        ...
        child: InkWell(
            onTap: () {
              ...
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => DetailsPage(coffeename,coffeedescription,coffeeprice,true)
              ));
            },
            child: Container(
                height: height/20,
